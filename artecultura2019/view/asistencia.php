        ...
        $(document).ready(function () {
            ...
            $(".listarAlumnos").click(function () {
                ...
                if($(".selectpickerGrupos").val()!=0){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '../controller/ControladorAsistencia.php',
                        data: {
                ...
                $("#cuerpolista").show();
                                ...
                                alert("No hay alumnos matriculados para este grupo taller.");
                                $("#listaAlumnos").html('');
                                //console.log(temp);
                                $("#listaAsistencias").html('');
                                $("#cabeceralista").hide();
                                $("#cuerpolista").hide();
                    ...
                    <table class='table table-bordered table-sm' id='t_listaAlumnos' cellspacing='0'>
                        <thead>
                            <tr>
                                ...
                                <th scope="col" width="18%">CUI</th>
                                <th scope="col" width="78%">Nombre</th>
                            </tr>
                        </thead>
